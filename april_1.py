...
roadmap_data = {
    ...
    "GF From Ops": [
        {"Name": "Coach portal - editing questionnaire so that goals created (addition and deletion from coach side from portal side) - super imp", "Why": "During assessment if coaches feel goals need to be added, important to add this to be able to have better scores", "Status": "Picked in April", "Comments": None},
        {"Name": "Coach portal - patient history and profile as a patient profile - creat a form. Instead of part of each assessment - important", "Why": "Old assessment form questions have been translated into Custom goals. Some questions are history based. Important to have these separated from custom goals", "Status": "Picked in April", "Comments": "- likely to slip to may"},
    ...
    "GF tech debt": [
        {"Item": "Logging mechanisms of APIs to track user journey (last 9 integration for all critical APIs)", "Why": "Debugging issues is not possible without this", "Status": "Picked in april", "Comments": None},
        ...
        {"Item": "AI med report-- > in range and out of range value problems --> split the prompt into digitizing and then fixing the range (celebal can do)", "Why": "Important for experience. Also for scoring", "Status": "Picked in april", "Comments": None},
        ...
        {"Item": "User registration API performance (takes 7-8 seconds as of today)", "Why": "Can affect marketing funnels", "Status": "Picked in april", "Comments": None},
    ...
    "GF From Marketing": [
        ...
        {"Item": "LSQ Integration", "Why?": None, "Status": "Picked in April", "Comments": "P0"},
    ...
    "GF from Sales": [
        ...
        {"Item": "MedEco - Remote care enablement ( for referred patients --> show Achieve) + close referral flow?", "Why?": None, "Status": "Picked in april", "Comments": None}
    ],
    "GF Innovation": [
